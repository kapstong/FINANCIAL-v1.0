  ...
  <div id="contextBar" class="sticky top-14 z-40 border-b border-[var(--ring)] bg-white/80 backdrop-blur">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-12 flex items-center justify-between">
      <div class="flex items-center gap-3">
        <span class="font-semibold text-slate-800">Accounts Payable</span>
      </div>
        ...
        <section class="card p-5">
          ...
          <div class="mt-4 border-t border-[var(--ring)] pt-4">
              ...
              <table class="min-w-full text-sm">
                ...
                <tbody>
                  <tr class="border-t">
                    ...
                    <td class="px-3 py-2">BILL-0001</td>
                    <td class="px-3 py-2">Sample Vendor</td>
                    <td class="px-3 py-2">₱2,500.00</td>
            ...
            <div class="mt-5 grid grid-cols-1 md:grid-cols-2 gap-5">
              <div class="card p-4">
                <div class="font-semibold mb-2">Payable Summary</div>
                <p class="text-sm text-slate-600">Total outstanding: <b>₱8,750.00</b></p>
                <p class="text-sm text-slate-600">Overdue: <b>₱1,200.00</b></p>
              </div>
              <div class="card p-4">
                <div class="font-semibold mb-2">Quick Actions</div>
                <p class="text-sm text-slate-600">Add quick action buttons for <b>${tab.label}</b> here.</p>
              </div>
            </div>
          </div>
        </section>
