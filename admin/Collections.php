  ...
  <div id="contextBar" class="sticky top-14 z-40 border-b border-[var(--ring)] bg-white/80 backdrop-blur">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-12 flex items-center justify-between">
      <div class="flex items-center gap-3">
        <span class="font-semibold text-slate-800">Collections</span>
      </div>
  ...
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-6 py-6">
    ...
    <aside id="sidebar" class="fixed lg:static left-0 top-14 lg:top-auto w-64 lg:w-full h-[calc(100vh-56px)] lg:h-auto bg-white border-r border-[var(--ring)] sidebar-transition -translate-x-full lg:translate-x-0 z-50 overflow-y-auto">
      <nav class="p-3 space-y-1">
        <div class="text-[11px] uppercase tracking-wide text-slate-500 px-2 pt-2 pb-1">Navigation</div>
      ...
      host.innerHTML = `
        <section class="card p-5">
          <div class="flex items-center justify-between">
            ...
            <div class="bg-slate-50 border border-slate-200 rounded-lg p-4 w-full">
              <div class="filter-grid">
                <div>
                  <label class="block text-sm font-medium text-slate-700 mb-2">Customer</label>
                  <select class="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">
                ...
                <div>
                  <label class="block text-sm font-medium text-slate-700 mb-2">Collection Status</label>
                  <select class="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">
                ...
                <div>
                  ...
                  <input type="date" class="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent">
                </div>
                <div>
              ...
              <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100">
                  <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="px-4 py-3 font-mono text-slate-900 font-medium">COL-0001</td>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
              <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                <div class="text-xs uppercase tracking-wide text-green-600 font-semibold">Total Collected</div>
                <div class="text-2xl font-bold text-green-800 mt-1">₱15,750.00</div>
                <div class="text-xs text-green-600 mt-1">This month</div>
              </div>
              <div class="bg-orange-50 border border-orange-200 rounded-lg p-4">
                <div class="text-xs uppercase tracking-wide text-orange-600 font-semibold">Pending</div>
                <div class="text-2xl font-bold text-orange-800 mt-1">₱3,200.00</div>
                <div class="text-xs text-orange-600 mt-1">Awaiting collection</div>
              </div>
              <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                <div class="text-xs uppercase tracking-wide text-red-600 font-semibold">Overdue</div>
                <div class="text-2xl font-bold text-red-800 mt-1">₱1,800.00</div>
                <div class="text-xs text-red-600 mt-1">Past due date</div>
              </div>
              <div class="bg-slate-50 border border-slate-200 rounded-lg p-4">
                <div class="text-xs uppercase tracking-wide text-slate-600 font-semibold">Collection Rate</div>
